...
public class GuiAssertions {
    private static final Logger LOGGER = LoggerFactory.getLogger(GuiAssertions.class);

    public static final long WAIT_TIMEOUT_DURATION = 1000;
    public static final Pattern NOT_FOUND_REGEX = Pattern.compile("^Timed out waiting for (.*) to be found using matcher ([\\s\\S]*)$");
