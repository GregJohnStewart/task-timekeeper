...
public class ObjectMapperUtilities {
	...
	/**
	 * Sets up a mapper given to handle serializing Timekeeper objects. Modifies the object given and returns the same object for flexibility of implementation.
