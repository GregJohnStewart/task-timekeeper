...
public class TokenService {
    ...
    @Gauge(name = "numTotalIterations", unit = MetricUnits.NONE, description = "The number of iterations it took to generate token.")
    public Long numTotalIterations() {
        return this.numIterations;
    }

    @Gauge(name = "averageIterationsPerToken", unit = MetricUnits.NONE, description = "The average number of iterations it takes to make a token.")
